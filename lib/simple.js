 ...
 */
    ...
    */
    ...
    async send5Button(jid, content, footer, button1, row1, button2, row2, button3, row3, button4, row4, button5, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
          ...
          { buttonId: row5, buttonText: { displayText: button5 }, type: 1 }
        ],
        headerType: 1
      }, MessageType.buttonsMessage, { quoted, ...options })
    }
